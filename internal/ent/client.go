...
// UpdateOneID returns an update builder for the given id.
func (c *UserOauthProviderClient) UpdateOneID(id int) *UserOauthProviderUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *UserOauthProviderClient) DeleteOneID(id int) *UserOauthProviderDeleteOne {
...
func (c *UserOauthProviderClient) Get(ctx context.Context, id int) (*UserOauthProvider, error) {
	return c.Query().Where(useroauthprovider.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *UserOauthProviderClient) GetX(ctx context.Context, id int) *UserOauthProvider {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
